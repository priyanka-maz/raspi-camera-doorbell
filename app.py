...
'''
keanu_img = face_recognition.load_image_file("./face_img/S1.jpg")
keanu_encoding = face_recognition.face_encodings(keanu_img)[0]

ryan_img = face_recognition.load_image_file("./face_img/S2.jpg")
ryan_encoding = face_recognition.face_encodings(ryan_img)[0]

p_img = face_recognition.load_image_file("./face_img/S3.png")
p_encoding = face_recognition.face_encodings(p_img)[0]

known_face_encodings = [keanu_encoding, ryan_encoding, p_encoding]
known_face_names = ["Keanu Reeves", "Ryan Renolds", "Prateek"]


data_dict = {}
for i in range(len(known_face_names)):
    data_dict[known_face_names[i]] = known_face_encodings[i]
'''
        ...
        if not status:
            ...
            if process_this_frame == 0:
                ...
                for face_encoding in face_encodings:
                    ...
                    if face_distances[best_match_index] >= 0.54 :
                        pass
